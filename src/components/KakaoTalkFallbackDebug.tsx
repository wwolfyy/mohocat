  ...
  return (
    <div style={{ 
      ...
      <div style={{ marginTop: '15px', fontSize: '11px', color: '#666' }}>
        ...
        <ol>
          <li><strong>Normal Flow:</strong> Tests regular KakaoTalk authentication</li>
          <li><strong>Forced Fallback:</strong> Forces the two-step approach (anonymous + linking)</li>
