                ...
                <div className="text-center space-y-4">
                    ...
                    <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 text-left">
                        <p className="text-xs text-yellow-700">
                            <strong>Note:</strong> If you already have an account (via Email or Phone), please log in with that method first. Then, go to <strong>Settings</strong> to link your Google/Kakao account manually.
                        </p>
                    </div>
