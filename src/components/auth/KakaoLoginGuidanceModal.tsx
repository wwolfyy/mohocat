                ...
                return (
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-sm text-gray-500">
                            To log in with KakaoTalk, you must first have an account with us and have linked your KakaoTalk account to it.
                        </p>
            ...
            case 'guidance':
                return (
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-sm text-gray-500">
                            Please log in with Email or Phone first. Then go to <strong>Settings &gt; Account</strong> to link your KakaoTalk account.
                        </p>
                        <div className="mt-4">
                            <button
                                onClick={handleClose}
