    ...
    <div className={cn("max-w-4xl mx-auto p-6 space-y-6", className)}>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li><code>useAuth</code> - Enhanced authentication hook with OAuth support</li>
            <li><code>SocialLoginButton</code> - Reusable social login buttons</li>
            <li><code>LoginForm</code> - Enhanced login form with social options</li>
            <li><code>ProviderManagement</code> - OAuth provider management interface</li>
            <li><code>AdminAuth</code> - Enhanced admin authentication wrapper</li>
          </ul>
        </div>
      </div>
    </div>
