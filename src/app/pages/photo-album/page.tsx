    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-gray-900 text-center">사진첩</h1>
          <p className="text-gray-600 text-center mt-2">산양이 고양이들의 소중한 순간들</p>
        </div>
      </div>      {/* Content */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {filteredCats.length === 0 ? (
                ...
                <div className="grid grid-cols-2 gap-2 p-4">
                  {filteredCats.map((cat) => (
                    <label
                      key={cat.id}                      className={`flex items-center p-2 rounded cursor-pointer hover:bg-gray-50 ${
