...
export default function Contact() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 relative" data-oid="tcd6of1">
      ...
      {/* Grayed out content */}
      <div
        className="filter grayscale opacity-50 pointer-events-none"
        data-oid="8dwt2t:"
      >
        <h4 className="text-xl font-bold text-center mb-8" data-oid="c218kfo">
          고양이들 돌보기 또는 입양, 중성화 등을 통한 개체 수 조절에 동참을
          원하시면 아래 서식을 작성해 주세요
        </h4>
        ...
        <div
          ...
          data-oid="9_qk1_s"
        >
          If you use router.push or links to this page elsewhere, update their
          paths to '/pages/contact'.
        </div>
      </div>
    </div>
  );
