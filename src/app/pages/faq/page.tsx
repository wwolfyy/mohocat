...
const FAQPage = () => {
  const faqItems = [
    {
      question:
        "'ERR_BLOCKED_BY_CLIENT' 라는 오류가 브라우저 콘솔에 나타납니다. 무슨 오류인가요?",
      answer: (
        <div className="space-y-3" data-oid="ezxli.c">
          <p data-oid="ppk-svp">
            이 오류는 브라우저의 광고 차단기가 Firebase의 실시간 데이터베이스
            연결을 방해할 때 나타납니다. 완전히 무해하며 애플리케이션의 핵심
            기능에는 영향을 주지 않습니다.
          </p>
          <p data-oid="xw4v58g">
            <strong data-oid="g-8chky">발생 원인:</strong> 광고 차단기가 때때로
            Firebase의 WebSocket 연결을 차단하는데, 이는 URL에 추적과 유사한
            매개변수가 포함되어 있기 때문입니다.
          </p>
          <p data-oid="hqope1z">
            <strong data-oid="xkpvhjv">영향:</strong> 앱은 완벽하게 작동합니다 -
            여전히 동영상 업로드, 게시물 작성, 콘텐츠 보기가 가능합니다. 다른
            사용자가 콘텐츠를 게시할 때 실시간 업데이트만 놓칠 수 있습니다.
          </p>
          <p data-oid="nfcr1fa">
            <strong data-oid="78h4r..">해결 방법:</strong> 실시간 업데이트를
            원한다면 광고 차단기 설정에서 이 사이트를 허용 목록에 추가하는 것을
            고려해보세요. 그렇지 않으면 새 콘텐츠를 보기 위해 페이지를
            새로고침하면 됩니다.
          </p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div className="space-y-3" data-oid="37rzvv8">
          <p data-oid="3hug938">
            동영상을 업로드하려면 관리자의 승인이 필요합니다. 먼저 동참 서식을
            작성한 다음 회신을 기다려 주세요. 아이디를 포함한 회신이 오면 먼저
            로그인 한 후:
          </p>
          <ol
          ...
          <p data-oid="uorr5_x">
            동영상이 있는 경우 YouTube에 업로드되어 게시물에 삽입됩니다. 동영상
            크기에 따라 몇 초에서 몇 분 정도 걸릴 수 있습니다.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3" data-oid="a7.fj0a">
          ...
          <p data-oid="5krz:1b">
            큰 동영상은 당연히 더 오래 걸립니다. 업로드 중에는 브라우저를 닫지
            말고 기다려 주세요.
          </p>
        </div>
      ),
...

    {
      ...
      answer: (
        <div className="space-y-3" data-oid="6zxad1k">
          ...
          <p data-oid="a.vln2v">
            YouTube 서비스나 우리 웹사이트 데이터베이스의 일시적인 문제로 오류가
            발생할 수 있습니다.
          </p>
        </div>
      ),
