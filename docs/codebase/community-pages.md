...
| Butler stream    | `src/app/pages/butler_stream/{page,new}.tsx`, `ButlerStreamClient.tsx`, `ButlerStreamTabs.tsx`                              | 집사방송 feed                                                                                       |
| Posts            | `src/app/pages/posts/[id]/page.tsx`, `PostList.tsx`, `PostItem.tsx`, `NewPostForm.tsx`, `EditPostForm.tsx`                  | Generic post list/detail + create/edit                                                              |
