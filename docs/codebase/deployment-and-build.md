...
| Maintenance scripts        | `scripts/maintenance/cleanup_firestore_cat_videos.js`, `enforce_youtube_readonly_fields.js`, `firebase_ops.js`, `_*.py`                                                           | Operational data hygiene.                                                                                                                                                                                                                                                                                 |
