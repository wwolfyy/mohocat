...
| Admin tagging             | `src/app/admin/tag-images/page.tsx`, `tag-videos/page.tsx`, `src/components/admin/YouTubeAuthPanelNew.tsx`, `src/components/CatSelectorModal.tsx` | Batch operations: bulk tag, bulk delete, recording-date inference.                                                                                                   |
