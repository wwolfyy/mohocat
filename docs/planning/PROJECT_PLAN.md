...
| **Deployment-target cleanup**         | `[~]` in progress | **§7** — Vercel-only. **Phase 1 done** (commit `f62816b`: removed Cloud Run / home-server / Firebase-Hosting / Docker / static-export / functions; trimmed `firebase.json`). Phase 2/3 pending open Qs.          |
