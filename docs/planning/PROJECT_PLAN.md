...
> **EXECUTING: M1–M4 + M5.1 + M5.2 ✅ done & committed; M5.3 audit ✅ (docs-only).** M1–M3 (`8920c66`/`092d226`/
...
> **M5.4a stub tenant DONE 2026-07-23** — `manisan` added to `mountains.json`
> (`hidden: true`) + seeded; full e2e still 116/13/0. **Next = M5.4b two-tenant
> isolation spec** (+ wire `test:rules` into CI). Its §6
