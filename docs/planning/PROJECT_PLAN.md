...
> ✅ M6 DONE on `dev` (2026-07-25, uncommitted; no prod migration). Active track advances to
> M7 (analytics → gtag.js).** M1–M3 (`8920c66`/`092d226`/
...
> Gates: tsc 0, unit +2, smoke 30/30, **full e2e 125/13/0**. **Next open phase: M7.**
