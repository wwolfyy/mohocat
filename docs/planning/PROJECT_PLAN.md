...
> ✅ M6 (`d644d1b`) + M7 (`48f7085`) committed on `dev`; ✅ M8 code+docs complete on `dev`
> (2026-07-25). All phases M0–M8 done — only owner-gated externalities remain.** M1–M3
> (`8920c66`/`092d226`/
...
>
> **✅ M6 DONE on `dev` 2026-07-25 (uncommitted; no prod cutover) — per-tenant upload
...
>
> **✅ M8 DONE on `dev` 2026-07-25 (uncommitted) — geyang-as-one-of-many + per-tenant
