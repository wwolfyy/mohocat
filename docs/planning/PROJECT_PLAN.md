...
| Member post authoring                          | `[x]` built, ⚠️ not live | §10n — butler roles view / create / **edit their own** on 집사톡 + 급식현황 (`8334c51`). 🔑 The ask's premise was false: members could not see or create at all, so "let the author edit" had no non-admin author to apply to. Two per-board permissions, `authorUid` as the authorization identity, rules that refuse an edit rewriting authorship, and a member edit route outside `/admin`. 🔴 **Rules undeployed + permissions migration dry-run only** — inert in prod until both run, in that order, before the code ships.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
🔴 **NOT LIVE. Deploy order matters:** (1) `firebase deploy --only firestore:rules` — inert on
its own; (2) `APPLY=true node scripts/migration/add-member-post-permissions.js`; (3) push.
Reversing 1 and 3 gives members a composer whose save is denied.
