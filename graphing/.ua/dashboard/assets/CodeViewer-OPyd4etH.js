import { a as D, j as m } from './react-vendor-BVoutfaX.js';
import { u as U, a as ge } from './index-BSUMpTki.js';
import { M as ye, r as fe } from './markdown-DtJ_FMNT.js';
import './xyflow-BLuFBhnn.js';
import './graph-layout-DJJECaXo.js';
import './elk-CXeXGyKz.js';
import './graphology-BgTy_cc3.js';
function se(e) {
  var t,
    r,
    l = '';
  if (typeof e == 'string' || typeof e == 'number') l += e;
    ...
    if (Array.isArray(e)) {
      var p = e.length;
      for (t = 0; t < p; t++) e[t] && (r = se(e[t])) && (l && (l += ' '), (l += r));
    } else for (r in e) e[r] && (l && (l += ' '), (l += r));
  return l;
}
function oe() {
  for (var e, t, r = 0, l = '', p = arguments.length; r < p; r++)
    (e = arguments[r]) && (t = se(e)) && (l && (l += ' '), (l += t));
  return l;
}
var be = Object.create,
  ...
  C = (e, t) => {
    for (var r in t || (t = {})) J.call(t, r) && te(e, r, t[r]);
    if (q) for (var r of q(t)) ie.call(t, r) && te(e, r, t[r]);
    return e;
  },
  H = (e, t) => me(e, xe(t)),
  ce = (e, t) => {
    var r = {};
    for (var l in e) J.call(e, l) && t.indexOf(l) < 0 && (r[l] = e[l]);
    if (e != null && q) for (var l of q(e)) t.indexOf(l) < 0 && ie.call(e, l) && (r[l] = e[l]);
    return r;
  },
  we = (e, t) =>
    function () {
  ...
  Ee = (e, t, r, l) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let p of le(t))
        !J.call(e, p) &&
          p !== r &&
          W(e, p, { get: () => t[p], enumerable: !(l = he(t, p)) || l.enumerable });
    return e;
  },
  Ae = (e, t, r) => (
    (r = e != null ? be(ve(e)) : {}),
    Ee(!e || !e.__esModule ? W(r, 'default', { value: e, enumerable: !0 }) : r, e)
  ),
  Se = we({
      ...
      var r = (function () {
        var l = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
          ...
          d = {
            util: {
              encode: function n(a) {
                return a instanceof h
                  ? new h(a.type, n(a.content), a.alias)
                  : Array.isArray(a)
                    ? a.map(n)
                    : a
                        .replace(/&/g, '&amp;')
              ...
              clone: function n(a, o) {
                ...
                switch (d.util.type(a)) {
                  case 'Object':
                    if (((i = d.util.objId(a)), o[i])) return o[i];
                    ((u = {}), (o[i] = u));
                    for (var b in a) a.hasOwnProperty(b) && (u[b] = n(a[b], o));
                    return u;
                  case 'Array':
                    return (
                      (i = d.util.objId(a)),
              ...
              setLanguage: function (n, a) {
                ((n.className = n.className.replace(RegExp(l, 'gi'), '')),
                  n.classList.add('language-' + a));
              },
              isActive: function (n, a, o) {
                for (var u = 'no-' + a; n; ) {
                  var i = n.classList;
                  if (i.contains(a)) return !0;
                  if (i.contains(u)) return !1;
                  n = n.parentElement;
                }
                return !!o;
              },
            ...
            languages: {
              ...
              txt: x,
              extend: function (n, a) {
                var o = d.util.clone(d.languages[n]);
                for (var u in a) o[u] = a[u];
                return o;
              },
              insertBefore: function (n, a, o, u) {
                u = u || d.languages;
                var i = u[n],
                  b = {};
                for (var k in i)
                  if (i.hasOwnProperty(k)) {
                    if (k == a) for (var A in o) o.hasOwnProperty(A) && (b[A] = o[A]);
                    o.hasOwnProperty(k) || (b[k] = i[k]);
                  }
                var F = u[n];
                return (
                  (u[n] = b),
                  d.languages.DFS(d.languages, function (_, w) {
                    w === F && _ != n && (this[_] = b);
                  }),
                  b
                );
              },
              DFS: function n(a, o, u, i) {
                i = i || {};
                var b = d.util.objId;
                for (var k in a)
                  if (a.hasOwnProperty(k)) {
                    ...
                    var A = a[k],
                      F = d.util.type(A);
                    F === 'Object' && !i[b(A)]
                      ? ((i[b(A)] = !0), n(A, o, null, i))
                      : F === 'Array' && !i[b(A)] && ((i[b(A)] = !0), n(A, o, k, i));
                  }
              },
            },
            plugins: {},
            highlight: function (n, a, o) {
              var u = { code: n, grammar: a, language: o };
              if ((d.hooks.run('before-tokenize', u), !u.grammar))
                throw new Error('The language "' + u.language + '" has no grammar.');
              return (
                (u.tokens = d.tokenize(u.code, u.grammar)),
                d.hooks.run('after-tokenize', u),
                h.stringify(d.util.encode(u.tokens), u.language)
              );
            },
            tokenize: function (n, a) {
              ...
              var i = new c();
              return (g(i, i.head, n), f(n, i, a, i.head, 0), E(i));
            },
            hooks: {
              all: {},
              add: function (n, a) {
              ...
              run: function (n, a) {
                var o = d.hooks.all[n];
                if (!(!o || !o.length)) for (var u = 0, i; (i = o[u++]); ) i(a);
              },
            },
            Token: h,
          };
        ...
        h.stringify = function n(a, o) {
          ...
          var i = {
            ...
            b = a.alias;
          (b && (Array.isArray(b) ? Array.prototype.push.apply(i.classes, b) : i.classes.push(b)),
            d.hooks.run('wrap', i));
          var k = '';
          for (var A in i.attributes)
            k += ' ' + A + '="' + (i.attributes[A] || '').replace(/"/g, '&quot;') + '"';
          return (
            '<' +
            i.tag +
            ' class="' +
        ...
        function y(n, a, o, u) {
          ...
          if (i && u && i[1]) {
            var b = i[1].length;
            ((i.index += b), (i[0] = i[0].slice(b)));
          }
          return i;
        }
        function f(n, a, o, u, i, b) {
          for (var k in o)
            if (!(!o.hasOwnProperty(k) || !o[k])) {
              var A = o[k];
              A = Array.isArray(A) ? A : [A];
              for (var F = 0; F < A.length; ++F) {
                if (b && b.cause == k + ',' + F) return;
                var _ = A[F],
                  w = _.inside,
                  S = !!_.lookbehind,
                  N = !!_.greedy,
                  j = _.alias;
                if (N && !_.pattern.global) {
                  var O = _.pattern.toString().match(/[imsuy]*$/)[0];
                  _.pattern = RegExp(_.pattern.source, O + 'g');
                }
                for (
                  var M = _.pattern || _, R = u.next, T = i;
                  R !== a.tail && !(b && T >= b.reach);
                  T += R.value.length, R = R.next
                ) {
                  var B = R.value;
                  ...
                  if (!(B instanceof h)) {
                    var P = 1,
                      I;
                    if (N) {
                      if (((I = y(M, T, n, S)), !I || I.index >= n.length)) break;
                      var G = I.index,
                        Y = I.index + I[0].length,
                        $ = T;
                      for ($ += R.value.length; G >= $; ) ((R = R.next), ($ += R.value.length));
                      if ((($ -= R.value.length), (T = $), R.value instanceof h)) continue;
                      for (
                        var z = R;
                        z !== a.tail && ($ < Y || typeof z.value == 'string');
                        z = z.next
                      )
                        (P++, ($ += z.value.length));
                      (P--, (B = n.slice(T, $)), (I.index -= T));
                    } else if (((I = y(M, 0, B, S)), !I)) continue;
                    var G = I.index,
                      Z = I[0],
                      K = B.slice(0, G),
                      ee = B.slice(G + Z.length),
                      X = T + B.length;
                    b && X > b.reach && (b.reach = X);
                    var V = R.prev;
                    (K && ((V = g(a, V, K)), (T += K.length)), v(a, V, P));
                    var de = new h(k, w ? d.tokenize(Z, w) : Z, j, Z);
                    if (((R = g(a, V, de)), ee && g(a, R, ee), P > 1)) {
                      var Q = { cause: k + ',' + F, reach: X };
                      (f(n, a, o, R.prev, T, Q), b && Q.reach > b.reach && (b.reach = Q.reach));
                    }
                  }
                }
              }
        ...
        function g(n, a, o) {
          var u = a.next,
            i = { value: o, prev: a, next: u };
          return ((a.next = i), (u.prev = i), n.length++, i);
        }
        function v(n, a, o) {
          for (var u = a.next, i = 0; i < o && u !== n.tail; i++) u = u.next;
          ((a.next = u), (u.prev = a), (n.length -= i));
        }
        function E(n) {
          for (var a = [], o = n.head.next; o !== n.tail; ) (a.push(o.value), (o = o.next));
          return a;
        }
        return d;
      })();
...
((s.languages.markup = {
      ...
      var r = {},
        r =
          ((r['language-' + l] = {
            pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
            lookbehind: !0,
            inside: s.languages[l],
          }),
          (r.cdata = /^<!\[CDATA\[|\]\]>$/i),
          { 'included-cdata': { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: r } }),
        l = ((r['language-' + l] = { pattern: /[\s\S]+/, inside: s.languages[l] }), {});
      ((l[e] = {
        pattern: RegExp(
        ...
        s.languages.insertBefore('markup', 'cdata', l));
    },
  }),
    ...
    e.languages.regex = {
      'char-class': {
        ...
        inside: {
          ...
          range: {
            pattern: l,
            inside: { escape: r, 'range-punctuation': { pattern: /-/, alias: 'operator' } },
          },
          'special-escape': t,
  ...
  (s.languages.actionscript = s.languages.extend('javascript', {
    keyword:
      /\b(?:as|break|case|catch|class|const|default|delete|do|dynamic|each|else|extends|final|finally|for|function|get|if|implements|import|in|include|instanceof|interface|internal|is|namespace|native|new|null|override|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|use|var|void|while|with)\b/,
    operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/,
  })),
  (s.languages.actionscript['class-name'].alias = 'function'),
  delete s.languages.actionscript.parameter,
  delete s.languages.actionscript['literal-property'],
  s.languages.markup &&
    s.languages.insertBefore('actionscript', 'string', {
      xml: {
    ...
    ((e.languages.coffeescript = e.languages.extend('javascript', {
      ...
      e.languages.insertBefore('coffeescript', 'string', {
        ...
        'multiline-string': [
          ...
          { pattern: /"""[\s\S]*?"""/, greedy: !0, alias: 'string', inside: { interpolation: r } },
        ],
      }),
  ...
  (function (e) {
    ...
    (Object.defineProperty(t, 'addSupport', {
      value: function (r, l) {
        (r = typeof r == 'string' ? [r] : r).forEach(function (p) {
          var x = function (g) {
          ...
          if ((h = e.languages[p])) {
            ...
            if (
              ((y =
                y ||
                (h = e.languages.insertBefore(p, 'comment', {
                  'doc-comment': {
                    pattern: /(^|[^\\])\/\*\*[^/][\s\S]*?(?:\*\/|$)/,
                    lookbehind: !0,
                    alias: 'comment',
                  },
                }))[d]) instanceof RegExp && (y = h[d] = { pattern: y }),
              Array.isArray(y))
            )
              for (var f = 0, c = y.length; f < c; f++)
                (y[f] instanceof RegExp && (y[f] = { pattern: y[f] }), x(y[f]));
            else x(y);
          }
        });
      },
    ...
    e.languages.insertBefore('css', 'function', {
      ...
      color: [
        ...
        },
        {
          ...
          inside: { unit: t, number: r, function: /[\w-]+(?=\()/, punctuation: /[(),]/ },
        },
      ],
      entity: /\\[\da-f]{1,8}/i,
      unit: t,
  ...
  (function (e) {
    var t = /[*&][^\s[\]{},]+/,
      r = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/,
      l = '(?:' + r.source + '(?:[ 	]+' + t.source + ')?|' + t.source + '(?:[ 	]+' + r.source + ')?)',
      p =
    ...
    ((e.languages.yaml = {
      ...
      string: { pattern: d(x), lookbehind: !0, greedy: !0 },
      number: {
        pattern: d(
    ...
    var l = /(?:\\.|``(?:[^`\r\n]|`(?!`))+``|`[^`\r\n]+`|[^\\|\r\n`])+/.source,
      ...
      d =
        ...
        e.languages.insertBefore('markdown', 'prolog', {
          ...
          table: {
            pattern: RegExp('^' + p + x + '(?:' + p + ')*', 'm'),
            inside: {
              'table-data-rows': {
                pattern: RegExp('^(' + p + x + ')(?:' + p + ')*$'),
                lookbehind: !0,
                inside: {
                  'table-data': { pattern: RegExp(l), inside: e.languages.markdown },
                  punctuation: /\|/,
                },
              },
              'table-line': {
        ...
        ['url', 'bold', 'italic', 'strike'].forEach(function (f) {
          ['url', 'bold', 'italic', 'strike', 'code-snippet'].forEach(function (c) {
            f !== c && (e.languages.markdown[f].inside.content.inside[c] = e.languages.markdown[c]);
          });
        }),
        e.hooks.add('after-tokenize', function (f) {
          (f.language !== 'markdown' && f.language !== 'md') ||
            (function c(g) {
              if (g && typeof g != 'string')
                for (var v = 0, E = g.length; v < E; v++) {
                  var n,
                    a = g[v];
                  a.type !== 'code'
                    ? c(a.content)
                    : ((n = a.content[1]),
                      ...
                      n &&
                        ...
                        ((n = n.content.replace(/\b#/g, 'sharp').replace(/\b\+\+/g, 'pp')),
                        (n = 'language-' + (n = (/[a-z][\w-]*/i.exec(n) || [''])[0].toLowerCase())),
                        a.alias
        ...
        e.hooks.add('wrap', function (f) {
          if (f.type === 'code-block') {
            for (var c = '', g = 0, v = f.classes.length; g < v; g++) {
              var E = f.classes[g],
                E = /language-(.+)/.exec(E);
              if (E) {
                c = E[1];
            ...
            var n,
              a = e.languages[c];
            a
              ? (f.content = e.highlight(
                  (function (o) {
                    return (
                      (o = o.replace(d, '')),
                      (o = o.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function (u, i) {
                        var b;
                        return (i = i.toLowerCase())[0] === '#'
                          ? ((b = i[1] === 'x' ? parseInt(i.slice(2), 16) : Number(i.slice(1))),
                            y(b))
                          : h[i] || u;
                      }))
                    );
              ...
              : c &&
                ...
                ((n = 'md-' + new Date().valueOf() + '-' + Math.floor(1e16 * Math.random())),
                (f.attributes.id = n),
                e.plugins.autoloader.loadLanguages(c, function () {
                  var o = document.getElementById(n);
                  o && (o.innerHTML = e.highlight(o.textContent, e.languages[c], c));
                }));
          }
        }),
  ...
  s.hooks.add('after-tokenize', function (e) {
    if (e.language === 'graphql')
      for (
        ...
        if (l.type === 'keyword' && l.content === 'mutation') {
          var p = [];
          if (g(['definition-mutation', 'punctuation']) && c(1).content === '(') {
            r += 2;
            var x = v(/^\($/, /^\)$/);
            if (x === -1) continue;
            for (; r < x; r++) {
              var d = c(0);
              d.type === 'variable' && (E(d, 'variable-input'), p.push(d.content));
            }
            r = x + 1;
          }
          if (
            ...
            c(0).content === '{' &&
            (r++, E(c(0), 'property-mutation'), 0 < p.length)
          ) {
            var h = v(/^\{$/, /^\}$/);
            if (h !== -1)
              for (var y = r; y < h; y++) {
                var f = t[y];
                f.type === 'variable' && 0 <= p.indexOf(f.content) && E(f, 'variable-input');
              }
          }
        }
      }
    ...
    function g(n, a) {
      ...
      for (var o = 0; o < n.length; o++) {
        var u = c(o + a);
        if (!u || u.type !== n[o]) return;
      }
      return 1;
    }
    function v(n, a) {
      for (var o = 1, u = r; u < t.length; u++) {
        var i = t[u],
          b = i.content;
        if (i.type === 'punctuation' && typeof b == 'string') {
          if (n.test(b)) o++;
          else if (a.test(b) && --o === 0) return u;
        }
      }
      return -1;
    }
    function E(n, a) {
      var o = n.alias;
      (o ? Array.isArray(o) || (n.alias = o = [o]) : (n.alias = o = []), o.push(a));
    }
  }),
  (s.languages.sql = {
  ...
  (function (e) {
    var t = e.languages.javascript['template-string'],
      r = t.pattern.source,
      l = t.inside.interpolation,
      p = l.inside['interpolation-punctuation'],
      x = l.pattern.source;
    function d(g, v) {
      if (e.languages[g])
        return {
          pattern: RegExp('((?:' + v + ')\\s*)' + r),
          lookbehind: !0,
          greedy: !0,
          inside: {
            'template-punctuation': { pattern: /^`|`$/, alias: 'string' },
            'embedded-code': { pattern: /[\s\S]+/, alias: g },
          },
        };
    }
    function h(g, v, E) {
      return (
        (g = { code: g, grammar: v, language: E }),
        e.hooks.run('before-tokenize', g),
        (g.tokens = e.tokenize(g.code, g.grammar)),
        e.hooks.run('after-tokenize', g),
        g.tokens
      );
    }
    function y(g, v, E) {
      var o = e.tokenize(g, { interpolation: { pattern: RegExp(x), lookbehind: !0 } }),
        n = 0,
        a = {},
        o = h(
          o
            .map(function (i) {
              ...
              for (
                var b, k, i = i.content;
                g.indexOf(((k = n++), (b = '___' + E.toUpperCase() + '_' + k + '___'))) !== -1;
              );
              return ((a[b] = i), b);
            })
            .join(''),
        ...
        (function i(b) {
          for (var k = 0; k < b.length; k++) {
            ...
            var A,
              ...
              j,
              O = b[k];
            typeof O == 'string' || typeof O.content == 'string'
              ? ((A = u[n]),
                (j = (N = typeof O == 'string' ? O : O.content).indexOf(A)) !== -1 &&
                  (++n,
                  (F = N.substring(0, j)),
                  (S = a[A]),
                  (_ = void 0),
                  ((w = {})['interpolation-punctuation'] = p),
                  (w = e.tokenize(S, w)).length === 3 &&
                    ((_ = [1, 1]).push.apply(_, h(w[1], e.languages.javascript, 'javascript')),
                    w.splice.apply(w, _)),
                  (_ = new e.Token('interpolation', w, l.alias, S)),
                  (w = N.substring(j + A.length)),
                  (S = []),
                  F && S.push(F),
                  S.push(_),
                  w && (i((N = [w])), S.push.apply(S, N)),
                  typeof O == 'string'
                    ? (b.splice.apply(b, [k, 1].concat(S)), (k += S.length - 1))
                    : (O.content = S)))
              : ((j = O.content), Array.isArray(j) ? i(j) : i([j]));
          }
        })(o),
        new e.Token(E, o, 'language-' + E, g)
      );
    }
    e.languages.javascript['template-string'] = [
      ...
      d('graphql', /\b(?:gql|graphql(?:\s*\.\s*experimental)?)/.source),
      d('sql', /\bsql/.source),
      t,
    ].filter(Boolean);
    var f = { javascript: !0, js: !0, typescript: !0, ts: !0, jsx: !0, tsx: !0 };
    function c(g) {
      return typeof g == 'string' ? g : Array.isArray(g) ? g.map(c).join('') : c(g.content);
    }
        ...
        (function v(E) {
          for (var n = 0, a = E.length; n < a; n++) {
            ...
            typeof b != 'string' &&
              ((o = b.content),
              Array.isArray(o)
                ? b.type === 'template-string'
                  ? ((b = o[1]),
                    o.length === 3 &&
                      typeof b != 'string' &&
                      b.type === 'embedded-code' &&
                      ((u = c(b)),
                      (b = b.alias),
  ...
  (s.languages.n4js = s.languages.extend('javascript', {
    keyword:
  ...
  (function (e) {
    ...
    for (
      var r = ['function', 'function-variable', 'method', 'method-variable', 'property-access'],
        l = 0;
      l < r.length;
      l++
    ) {
      var x = r[l],
        p = e.languages.javascript[x],
        x =
          (p = e.util.type(p) === 'RegExp' ? (e.languages.javascript[x] = { pattern: p }) : p)
            .inside || {};
      (p.inside = x)['maybe-class-name'] = /^[A-Z][\s\S]*/;
    }
  })(s),
  (function (e) {
    ...
    ((p = x(p).source),
      ...
      e.languages.insertBefore(
        'inside',
        'attr-name',
        { spread: { pattern: x(/<SPREAD>/.source), inside: e.languages.jsx } },
        e.languages.jsx.tag
      ),
      e.languages.insertBefore(
        'inside',
    ...
    function d(y) {
      for (var f = [], c = 0; c < y.length; c++) {
        var g = y[c],
          v = !1;
        (typeof g != 'string' &&
          (g.type === 'tag' && g.content[0] && g.content[0].type === 'tag'
            ? g.content[0].content[0].content === '</'
              ? 0 < f.length && f[f.length - 1].tagName === h(g.content[0].content[1]) && f.pop()
              : g.content[g.content.length - 1].content !== '/>' &&
                f.push({ tagName: h(g.content[0].content[1]), openedBraces: 0 })
            : 0 < f.length && g.type === 'punctuation' && g.content === '{'
              ? f[f.length - 1].openedBraces++
              : 0 < f.length &&
                  0 < f[f.length - 1].openedBraces &&
                  g.type === 'punctuation' &&
                  g.content === '}'
                ? f[f.length - 1].openedBraces--
                : (v = !0)),
          (v || typeof g == 'string') &&
            ...
            ((v = h(g)),
            c < y.length - 1 &&
              (typeof y[c + 1] == 'string' || y[c + 1].type === 'plain-text') &&
              ((v += h(y[c + 1])), y.splice(c + 1, 1)),
            0 < c &&
              (typeof y[c - 1] == 'string' || y[c - 1].type === 'plain-text') &&
              ((v = h(y[c - 1]) + v), y.splice(c - 1, 1), c--),
            (y[c] = new e.Token('plain-text', v, null, v))),
  ...
  s.languages.insertBefore('c', 'string', {
    macro: {
      ...
      alias: 'property',
      inside: {
        string: [{ pattern: /^(#\s*include\s*)<[^>]+>/, lookbehind: !0 }, s.languages.c.string],
  ...
  (s.languages.python['string-interpolation'].inside.interpolation.inside.rest =
    s.languages.python),
...
ke(ue, {
  ...
  duotoneLight: () => Ie,
  github: () => Oe,
  gruvboxMaterialDark: () => it,
  gruvboxMaterialLight: () => ut,
  jettwaveDark: () => et,
  jettwaveLight: () => rt,
  nightOwl: () => Ce,
  nightOwlLight: () => Be,
...
var _e = {
  ...
  $e = {
    ...
    styles: [
      { types: ['attr-name'], style: { color: L.keyword } },
      { types: ['attr-value'], style: { color: L.string } },
      {
        types: ['comment', 'block-comment', 'prolog', 'doctype', 'cdata', 'shebang'],
        style: { color: L.comment },
      },
      {
        types: ['property', 'number', 'function-name', 'constant', 'symbol', 'deleted'],
        style: { color: L.primitive },
      },
      { types: ['boolean'], style: { color: L.boolean } },
      { types: ['tag'], style: { color: L.tag } },
      { types: ['string'], style: { color: L.string } },
      { types: ['punctuation'], style: { color: L.string } },
      { types: ['selector', 'char', 'builtin', 'inserted'], style: { color: L.char } },
      { types: ['function'], style: { color: L.function } },
      { types: ['operator', 'entity', 'url', 'variable'], style: { color: L.variable } },
      { types: ['keyword'], style: { color: L.keyword } },
  ...
  pt = (e) =>
    D.useCallback(
      (t) => {
        var r = t,
          { className: l, style: p, line: x } = r,
          d = ce(r, ['className', 'style', 'line']);
        const h = H(C({}, d), { className: oe('token-line', l) });
        return (
          typeof e == 'object' && 'plain' in e && (h.style = e.plain),
          typeof p == 'object' && (h.style = C(C({}, h.style || {}), p)),
          h
        );
      },
      [e]
  ...
  dt = (e) => {
        ...
        if (e != null) {
          {
            ...
            if (r.length === 1 && l != null) return e[r[0]];
          }
          return Object.assign(l != null ? { display: 'inline-block' } : {}, ...r.map((p) => e[p]));
        }
      },
      [e]
    );
    return D.useCallback(
      (r) => {
        var l = r,
          { token: p, className: x, style: d } = l,
          h = ce(l, ['token', 'className', 'style']);
        const y = H(C({}, h), {
          className: oe('token', ...p.types, x),
          children: p.content,
          style: t(p),
        });
        return (d != null && (y.style = C(C({}, y.style || {}), d)), y);
      },
      [t]
    );
  },
...
`),
    ...
    for (; d > -1; ) {
      for (; (x = l[d]++) < p[d]; ) {
        ...
        if (
          (typeof v == 'string'
            ? ((c = d > 0 ? c : ['plain']), (f = v))
            : ((c = ae(c, v.type)), v.alias && (c = ae(c, v.alias)), (f = v.content)),
          typeof f != 'string')
        ) {
          (d++, t.push(c), r.push(f), l.push(0), p.push(f.length));
          continue;
        }
        const E = f.split(gt),
          n = E.length;
        h.push({ types: c, content: E[0] });
        for (let a = 1; a < n; a++) (re(h), y.push((h = [])), h.push({ types: c, content: E[a] }));
      }
      (d--, t.pop(), r.pop(), l.pop(), p.pop());
    }
    return (re(h), y);
  },
  ne = yt,
  ft = ({ prism: e, code: t, grammar: r, language: l }) =>
    D.useMemo(() => {
      if (r == null) return ne([t]);
      const p = { code: t, grammar: r, language: l, tokens: [] };
      return (
        e.hooks.run('before-tokenize', p),
        (p.tokens = e.tokenize(t, r)),
        e.hooks.run('after-tokenize', p),
        ne(p.tokens)
      );
    }, [t, r, l, e]),
  bt = (e, t) => {
    const { plain: r } = e,
      l = e.styles.reduce((p, x) => {
        const { languages: d, style: h } = x;
        return (
          (d && !d.includes(t)) ||
            x.types.forEach((y) => {
              const f = C(C({}, p[y]), h);
    ...
    return ((l.root = r), (l.plain = H(C({}, r), { backgroundColor: void 0 })), l);
  },
  mt = bt,
  ht = ({ children: e, language: t, code: r, theme: l, prism: p }) => {
    const x = t.toLowerCase(),
      d = mt(l, x),
      h = pt(d),
      y = dt(d),
      f = p.languages[x],
      c = ft({ prism: p, language: x, code: r, grammar: f });
    return e({
      tokens: c,
      className: `prism-code language-${x}`,
      style: d != null ? d.root : {},
      getLineProps: h,
      getTokenProps: y,
    });
  ...
  xt = (e) =>
    D.createElement(
      ht,
      H(C({}, e), { prism: e.prism || s, theme: e.theme || pe, code: e.code, language: e.language })
    );
...
prismjs/prism.js:
   ...
   *)
*/ function vt(e, t) {
  return `/file-content.json?${new URLSearchParams({ token: t, path: e }).toString()}`;
}
function wt(e) {
  var l;
  const t = (l = e == null ? void 0 : e.split('.').pop()) == null ? void 0 : l.toLowerCase();
  return t
    ? ({
        css: 'css',
        go: 'go',
...
function Et({ content: e }) {
  return m.jsx('div', {
    className: 'px-6 py-5 max-w-3xl text-sm text-text-secondary leading-relaxed',
    children: m.jsx(ye, {
      remarkPlugins: [fe],
      components: {
        h1: ({ children: t }) =>
          m.jsx('h1', {
            className: 'text-xl font-heading text-text-primary mt-6 mb-3 first:mt-0',
            children: t,
          }),
        h2: ({ children: t }) =>
          m.jsx('h2', {
            className:
              'text-lg font-heading text-text-primary mt-5 mb-2 first:mt-0 border-b border-border-subtle pb-1',
            children: t,
          }),
        h3: ({ children: t }) =>
          m.jsx('h3', {
            className: 'text-base font-heading text-text-primary mt-4 mb-2 first:mt-0',
            children: t,
          }),
        h4: ({ children: t }) =>
          m.jsx('h4', {
            className: 'text-sm font-heading text-text-primary mt-3 mb-1.5 first:mt-0',
            children: t,
          }),
        h5: ({ children: t }) =>
          m.jsx('h5', {
        ...
        h6: ({ children: t }) =>
          m.jsx('h6', {
            className:
              'text-xs font-heading text-text-primary mt-3 mb-1.5 first:mt-0 uppercase tracking-wider',
            children: t,
          }),
        p: ({ children: t }) => m.jsx('p', { className: 'mb-3 last:mb-0', children: t }),
        a: ({ children: t, href: r }) =>
          m.jsx('a', {
            href: r,
            target: '_blank',
        ...
        ul: ({ children: t }) =>
          m.jsx('ul', { className: 'list-disc pl-5 mb-3 space-y-1', children: t }),
        ol: ({ children: t }) =>
          m.jsx('ol', { className: 'list-decimal pl-5 mb-3 space-y-1', children: t }),
        blockquote: ({ children: t }) =>
          m.jsx('blockquote', {
            className: 'border-l-2 border-accent/40 pl-3 text-text-muted italic mb-3',
            children: t,
          }),
        hr: () => m.jsx('hr', { className: 'border-border-subtle my-4' }),
        pre: ({ children: t }) =>
          m.jsx('pre', {
            className:
              'bg-elevated border border-border-subtle rounded-lg p-3 mb-3 overflow-x-auto text-xs font-mono',
            children: t,
          }),
        code: ({ className: t, children: r }) =>
          !t &&
          !String(r).includes(`
`)
            ? m.jsx('code', {
                className: 'bg-elevated px-1.5 py-0.5 rounded text-[0.85em] font-mono text-accent',
                children: r,
              })
            : m.jsx('code', { className: t, children: r }),
        table: ({ children: t }) =>
          m.jsx('div', {
            className: 'overflow-x-auto mb-3',
            children: m.jsx('table', { className: 'text-xs border-collapse', children: t }),
          }),
        th: ({ children: t }) =>
          m.jsx('th', {
            className:
              'border border-border-subtle bg-elevated px-2.5 py-1.5 text-left text-text-primary font-semibold',
            children: t,
          }),
        td: ({ children: t }) =>
          m.jsx('td', { className: 'border border-border-subtle px-2.5 py-1.5', children: t }),
        img: ({ src: t, alt: r }) =>
          m.jsx('img', {
            src: t,
            alt: r,
...
function It({ accessToken: e, presentation: t = 'sidebar', onClose: r, onExpand: l }) {
  const p = U((w) => w.graph),
    x = U((w) => w.domainGraph),
    d = U((w) => w.viewMode),
    h = U((w) => w.codeViewerNodeId),
    y = U((w) => w.closeCodeViewer),
    f = d === 'domain' && x ? x : p,
    c =
      (f == null ? void 0 : f.nodes.find((w) => w.id === h)) ??
      (p == null ? void 0 : p.nodes.find((w) => w.id === h)) ??
      null,
    [g, v] = D.useState({ status: 'idle', source: null, error: null }),
    [E, n] = D.useState('rendered'),
    { t: a } = ge();
  D.useEffect(() => {
    if (!(c != null && c.filePath)) {
      v({ status: 'error', source: null, error: 'This node does not have a file path.' });
      return;
    }
    if (e === '__demo__') {
      v({
    ...
    return (
      v({ status: 'loading', source: null, error: null }),
      fetch(vt(c.filePath, e), { signal: w.signal })
        .then(async (S) => {
          const N = await S.json();
          if (!S.ok) throw new Error('error' in N && N.error ? N.error : 'Source unavailable');
          v({ status: 'loaded', source: N, error: null });
        })
        .catch((S) => {
          w.signal.aborted ||
            v({ status: 'error', source: null, error: S instanceof Error ? S.message : String(S) });
        }),
      () => w.abort()
    );
  }, [e, c == null ? void 0 : c.filePath]);
  const o = D.useMemo(
    () => (c != null && c.lineRange ? { start: c.lineRange[0], end: c.lineRange[1] } : null),
    [c == null ? void 0 : c.lineRange]
  );
  if (!c)
    return m.jsx('div', {
      className: 'h-full w-full flex items-center justify-center bg-surface',
      children: m.jsx('p', { className: 'text-text-muted text-sm', children: a.codeViewer.noFile }),
    });
  const u = g.source,
    i = (u == null ? void 0 : u.language) ?? wt(c.filePath),
    b = i === 'markdown',
    k = b && E === 'rendered',
    A = o ? `${a.codeViewer.lines} ${o.start}-${o.end}` : a.codeViewer.fullFile,
    F = t === 'modal',
    _ = r ?? y;
  return m.jsxs('div', {
    ...
    children: [
      m.jsxs('div', {
        className:
          'flex items-start gap-3 px-4 py-3 bg-elevated border-b border-border-subtle shrink-0',
        children: [
          m.jsxs('div', {
            ...
            children: [
                ...
                children: [
                  m.jsx('span', {
                    ...
                    style: {
                      ...
                      backgroundColor:
                        'color-mix(in srgb, var(--color-node-file) 10%, transparent)',
                    },
                    children: i,
                  }),
                  m.jsx('span', { className: 'text-[10px] text-text-muted', children: A }),
                ],
              }),
              m.jsx('div', {
              ...
              c.filePath &&
                m.jsx('div', {
                  className: 'text-[11px] font-mono text-text-muted truncate mt-0.5',
                  title: c.filePath,
                  children: c.filePath,
                }),
            ],
            ...
            children: [
              l &&
                m.jsx('button', {
                  ...
                  title: a.codeViewer.openLarger,
                  'aria-label': a.codeViewer.openLarger,
                  children: m.jsx('svg', {
                    className: 'w-4 h-4',
                    fill: 'none',
                    stroke: 'currentColor',
              ...
              m.jsx('button', {
                ...
                onClick: _,
                className: 'text-text-muted hover:text-text-primary transition-colors',
                title: F ? a.codeViewer.closeExpanded : a.codeViewer.closeViewer,
                'aria-label': F ? a.codeViewer.closeExpanded : a.codeViewer.closeViewer,
                children: m.jsx('svg', {
                  className: 'w-4 h-4',
                  fill: 'none',
                  stroke: 'currentColor',
      ...
      m.jsxs('div', {
        className: 'flex-1 min-h-0 overflow-auto bg-root',
        children: [
          g.status === 'loading' &&
            m.jsx('div', {
              className: 'p-5 text-sm text-text-muted',
              children: a.codeViewer.loading,
            }),
          g.status === 'error' &&
            m.jsx('div', {
              className: 'p-5',
              children: m.jsxs('div', {
                ...
                children: [
                  m.jsx('div', {
                    ...
                    children: a.codeViewer.sourceUnavailable,
                  }),
                  m.jsx('p', {
          ...
          u &&
            m.jsxs(m.Fragment, {
              children: [
                m.jsxs('div', {
                  className:
                    'px-4 py-2 border-b border-border-subtle bg-surface text-[11px] text-text-muted flex items-center justify-between',
                  children: [
                    m.jsxs('span', { children: [u.lineCount, ' ', a.codeViewer.linesLabel] }),
                    m.jsxs('div', {
                      ...
                      children: [
                        b &&
                          m.jsx('div', {
                            className:
                              'flex items-center rounded border border-border-subtle overflow-hidden',
                            role: 'group',
                            children: ['rendered', 'source'].map((w) =>
                              m.jsx(
                                'button',
                                {
                                  type: 'button',
                                  onClick: () => n(w),
                                  className: `px-2 py-0.5 text-[10px] uppercase tracking-wider transition-colors ${E === w ? 'bg-accent/15 text-accent' : 'text-text-muted hover:text-text-primary'}`,
                                  'aria-pressed': E === w,
                                  children:
                                    w === 'rendered' ? a.codeViewer.rendered : a.codeViewer.source,
                                },
                                w
                              )
                            ),
                          }),
                        m.jsx('span', { children: kt(u.sizeBytes) }),
                      ],
                    }),
                  ],
                }),
                k && m.jsx(Et, { content: u.content }),
                !k &&
                  m.jsx(xt, {
                    code: u.content,
                    language: i,
                    ...
                    children: ({
                      ...
                      m.jsx('pre', {
                        className: `${w} min-w-max p-0 m-0 ${F ? 'text-xs leading-5' : 'text-[11px] leading-5'} font-mono`,
                        style: { ...S, background: 'transparent' },
                        children: N.map((M, R) => {
                          const T = R + 1,
                            B = o !== null && T >= o.start && T <= o.end,
                            P = j({ line: M });
                          return m.jsxs(
                            'div',
                            {
                              ...P,
                              className: `${P.className} flex ${B ? 'bg-accent/15' : 'hover:bg-elevated/40'}`,
                              children: [
                                m.jsx('span', {
                                  className:
                                    'w-12 shrink-0 select-none border-r border-border-subtle pr-3 text-right text-text-muted bg-surface/60',
                                  children: T,
                                }),
                                m.jsx('span', {
                                  className: 'pl-3 pr-6 whitespace-pre',
                                  children: M.map((I, Y) =>
                                    m.jsx('span', { ...O({ token: I }) }, Y)
                                  ),
                                }),
                              ],
                            },
